...
SIGNIN_SURFACE_URL = f"{MAIN_URL}/encourage/signIn/surface"
DATA_REVIEW_URL = f"{MAIN_URL}/encourage/three/getDataReview"
...
MINE_V2_URL = f"{MAIN_URL}/user/mineV2"
...
MATRIX_INDEX_URL = f"{MAIN_URL}/aki/roleBox/akiBox/newTowerIndex"
MATRIX_DETAIL_URL = f"{MAIN_URL}/aki/roleBox/akiBox/newTowerDetail"
# 浸梦海床+激斗！向着荣耀之丘
